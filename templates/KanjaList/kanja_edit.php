...
<a href="/kanjaEdit">
    <h1 class="text-5xl font-semi-bold text-center mt-5">患者情報編集</h1>
</a>
            ...
            <div class="sm:grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col">
                    ...
                    <?= $this->Form->control('name', [
                        'label' => false,
                        'class' => 'border rounded p-2 focus:outline-none focus:ring-2 text-2xl focus:ring-blue-400 disabled:bg-gray-200 cursor-not-allowed',
                        'placeholder' => '氏名',
                        'disabled' => true
                    ]) ?>
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <?= $this->Form->control('birth_year', [
                            ...
                            'label' => false,
                            'class' => 'border rounded p-1 focus:outline-none focus:ring-2 focus:ring-blue-400 text-xl',
                            'value' => $birthYear
                        ]) ?>
